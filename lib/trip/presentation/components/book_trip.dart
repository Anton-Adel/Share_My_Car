                  ...
                  TextFormField(
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null) {
                        ...
                        cubit.display_date_time(formattedDate,cubit.startDateController);
                      }
                    },
                  ),
                  const SizedBox(
                              ...
                              children: [
                                Row(
                                  children: const [
                                    ...
                                    Expanded(child: Text("Eslam Khaled Eid",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),)),
                                  ],
                                ),
                                Row(
                                  children: const [
                                    Text("Phone number:",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                                    //SizedBox(width: 10,),
                                ...
                                Row(
                                  children: const [
                                    Text("Distance:",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                                    Text("1Km",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                                    SizedBox(
                                      width: 15,
                                    ),
                                    Text("Time:",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),),
                                    Expanded(child: Text("10min",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400),)),
                                  ],
                                ),
                              ],
                            ),
